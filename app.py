...
app.title = "CMKL"
googledatalink='https://datastudio.google.com/s/gyLgdnxe4xE'
...
app.layout = html.Div([
    #########################Title
    html.Div([html.H1("COVID Example Network Graph")],
             className="row",
             style={'textAlign': "center"}),
    html.Div( html.A('Table Graph (Google Data Studio)', href=googledatalink)),
    #############################################################################################define the row
    html.Div(
        className="row",
        children=[
